...
const codeLogin = Math.floor(Math.random() * 1000000);
...
function loginUser(req, res){
    ...
    <body style="display: flex; justify-content: center;">
        <div class="validationEmail">
            ...
            <div class="text" style="border-top: 1px solid black; width: 510px;">
                <p style="margin-left: 70px;">thank you for created an account on Learning to Code.</p>
        <p style="margin-left: 70px;">This is your access code: <span class="code">${codeLogin}</        span></p>
            </div>
        </div>
    </body>
    </html>`;
...
module.exports = { registerUser, sendCode, loginCode, loginUser }